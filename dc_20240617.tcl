# DensityCalculator Version 20240617
# file_1 file_2: need these two files for calculation
# outputName: users can specify their own names for the ouputfiles
...
proc dc {file_1 file_2 outputName type firstFrame lastFrame step \
...
# ------Number density on YZ plane (unit:/nm^3)------	
	...
	for {set j 0} {$j<$xr} {incr j 1} {	
		...
		puts [format "The total number is %.0f" $totalNumber]
		close $writefile
	}
